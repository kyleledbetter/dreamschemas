...
import { ArrowRight, Play, FileSpreadsheet, Brain, Database } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              AI-powered schema generation with visual editing and one-click deployment. 
              From spreadsheet to database in minutes, not hours.
            </motion.p>
            ...
            >
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl hover:shadow-2xl transition-all group">
            ...
            <div className="relative bg-card border border-border rounded-2xl p-8 shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  ...
                  <span className="text-xs font-medium text-muted-foreground">CSV Files</span>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="flex flex-col items-center space-y-2"
                >
                  <div className="w-16 h-16 bg-primary/10 rounded-xl flex items-center justify-center relative">
              ...
              >
                <div className="text-xs font-mono text-muted-foreground space-y-1">
                  ...
                  <div className="ml-4">created_at TIMESTAMPTZ DEFAULT NOW()</div>
                  <div>);</div>
                </div>
              </motion.div>
            </div>
